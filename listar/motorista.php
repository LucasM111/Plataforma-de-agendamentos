...
<div class="card">
    <div class="card-header">
        <strong>Listas de Motoristas</strong>

        <div class="float-end">
            <a href="../cadastrar/motorista.php" class="btn btn-success btn-sm" title="Novo registro">
                <i class="fas fa-file"></i> Novo Motoristas
            </a>
            <a href="../listar/motorista.php" class="btn btn-info btn-sm">
                <i class="fas fa-search"></i> Listar Motoristas
            </a>
        </div>
    </div>
    <div class="card-body">
                    ...
                    ?>
                        <tr>
                            ...
                            <td class = text-center>
                                <!-- Icone Editar  -->
                                <a href = "../cadastrar/motoristas.php/<?=$d->id?>" title = "Editar" class = "btn btn-success btn-sm">
