...
<div class="card">
    <div class="card-header">
        ...
        <div class="float-end">
            <a href="../cadastrar/veiculos.php" class="btn btn-success btn-sm" title="Novo registro">
                    ...
                    ?>
                        <tr>
                            ...
                            <td class = text-center>
                                <!-- Icone Editar  -->
                                <a href = "../cadastrar/veiculos.php/<?=$d->id?>" title = "Editar" class = "btn btn-success btn-sm">
